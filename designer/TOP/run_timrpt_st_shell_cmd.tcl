read_sdc -scenario "timing_analysis" -netlist "optimized" -pin_separator "/" -ignore_errors {C:/Hello_fpga_12_2/HF10_OV7725_LCD_FF/designer/TOP/timing_analysis.sdc}
...
set max_slow_lv_ht [report \
    ...
    -analysis max \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_max_timing_slow_1.14V_100C.xml} ]
set min_fast_hv_lt [report \
    -type     timing \
    -analysis min \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_min_timing_fast_1.26V_-40C.xml} ]
set max_viol_slow_lv_ht [report \
    -type     timing_violations \
    -analysis max \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_max_timing_violations_slow_1.14V_100C.xml} ]
set min_viol_fast_hv_lt [report \
    -type     timing_violations \
    -analysis min \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_min_timing_violations_fast_1.26V_-40C.xml} ]
set coverage [report \
    -type     constraints_coverage \
    -format   xml \
    -slacks   no \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_timing_constraints_coverage.xml} ]
report \
    -type     combinational_loops \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_timing_combinational_loops.xml}
...
set max_fast_hv_lt [report \
    ...
    -analysis max \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_max_timing_fast_1.26V_-40C.xml} ]
set min_slow_lv_ht [report \
    -type     timing \
    -analysis min \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_min_timing_slow_1.14V_100C.xml} ]
set max_viol_fast_hv_lt [report \
    -type     timing_violations \
    -analysis max \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_max_timing_violations_fast_1.26V_-40C.xml} ]
set min_viol_slow_lv_ht [report \
    -type     timing_violations \
    -analysis min \
    -format   xml \
    {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_min_timing_violations_slow_1.14V_100C.xml} ]
set has_violations {C:\Hello_fpga_12_2\HF10_OV7725_LCD_FF\designer\TOP\TOP_has_violations}
